(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BoardComponent = /** @class */ (function () {
                function BoardComponent(sanitizer) {
                ...
                Object.defineProperty(BoardComponent.prototype, "currentPlayer1Class", {
                    get: function () {
                ...
                Object.defineProperty(BoardComponent.prototype, "currentPlayer2Class", {
                    get: function () {
                ...
                Object.defineProperty(BoardComponent.prototype, "notMyTurnClass", {
                    get: function () {
                ...
                Object.defineProperty(BoardComponent.prototype, "styleAttr", {
                    get: function () {
                        // const boxSize = 50;
                        // const boxLineSize = 8;
                        var boxSize = 80;
                ...
                BoardComponent.prototype.lines = function (box) {
                    return [
                ...
                BoardComponent.prototype.onClickLine = function (row, box, line) {
                    if (this.disabled) {
                        return;
                    }
                    this.clickLine.emit({ row: row, box: box, line: line });
                };
                BoardComponent.prototype.boundaryOwner = function (box) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatComponent = /** @class */ (function () {
                function ChatComponent(gameService) {
                    this.gameService = gameService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DesignComponent = /** @class */ (function () {
                function DesignComponent(designService, router, gameService) {
                    this.designService = designService;
                    this.router = router;
                    this.gameService = gameService;
                    this.sizes = [3, 4, 5, 8];
                }
                Object.defineProperty(DesignComponent.prototype, "board", {
                    get: function () {
                ...
                DesignComponent.prototype.onClickLine = function (_a) {
                    var row = _a.row, box = _a.box, line = _a.line;
                    var lineObj = _shared_board_service__WEBPACK_IMPORTED_MODULE_3__["getLine"](this.board, row, box, line);
                    lineObj.b = lineObj.b ? 0 : 1; // invert
                    this.designService.saveBoard();
                };
                DesignComponent.prototype.newBoard = function (size) {
                    this.designService.board = _shared_board_service__WEBPACK_IMPORTED_MODULE_3__["newBoard"](size);
                    this.designService.saveBoard();
                };
                DesignComponent.prototype.sizeWidth = function (incr) {
                    this.designService.sizeWidth(incr);
                    this.designService.saveBoard();
                };
                DesignComponent.prototype.sizeHeight = function (incr) {
                    this.designService.sizeHeight(incr);
                    this.designService.saveBoard();
                };
                DesignComponent.prototype.startGame = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameComponent = /** @class */ (function () {
                ...
                Object.defineProperty(GameComponent.prototype, "joined", {
                    get: function () {
                ...
                Object.defineProperty(GameComponent.prototype, "currentPlayer", {
                    get: function () {
                ...
                GameComponent.prototype.onClickLine = function (_a) {
                    var row = _a.row, box = _a.box, line = _a.line;
                    this.gameService.click(row, box, line);
                };
                Object.defineProperty(GameComponent.prototype, "boardDisabled", {
                    get: function () {
                ...
                GameComponent.prototype.playerTurn = function (index) {
                    return this.gameService.isPlayerTurn(index);
                };
                GameComponent.prototype.playerActive = function (index) {
                    var game = this.game;
                ...
                GameComponent.prototype.join = function () {
                    var name = this.playerName;
                    if (name) {
                        this.gameService.join({ name: name });
                    }
                };
                GameComponent.prototype.leave = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BOARD_KEY = 'dab-design-board';
            var MAX_BOARD_SIZE = 15;
            var MIN_BOARD_SIZE = 3;
            var DesignService = /** @class */ (function () {
                function DesignService() {
                }
                Object.defineProperty(DesignService.prototype, "board", {
                    get: function () {
                        if (this.$board) {
                            return this.$board;
                        }
                        var boardString = localStorage.getItem(BOARD_KEY);
                        if (boardString) {
                ...
                DesignService.prototype.saveBoard = function () {
                    localStorage.setItem(BOARD_KEY, JSON.stringify(this.board));
                };
                DesignService.prototype.newBoard = function (size) {
                    localStorage.removeItem(BOARD_KEY);
                    this.$board = _shared_board_service__WEBPACK_IMPORTED_MODULE_2__["newBoard"](size);
                };
                DesignService.prototype.sizeWidth = function (incr) {
                    var board = this.board;
                    var firstRow = board[0];
                    var amount = incr ? 1 : -1;
                    var newWidth = firstRow.length + amount;
                    if (newWidth < MIN_BOARD_SIZE || newWidth > MAX_BOARD_SIZE) {
                        return;
                    }
                    if (incr) {
                        board.forEach(function (row, rowIndex) {
                            var box = _shared_board_service__WEBPACK_IMPORTED_MODULE_2__["newBox"]();
                            box.r.b = 1;
                            if (rowIndex === 0) {
                                box.t.b = 1;
                            }
                        ...
                        board.forEach(function (row) {
                            ...
                            var box = row[row.length - 1];
                            box.r.b = 1;
                        });
                    }
                };
                DesignService.prototype.sizeHeight = function (incr) {
                    var board = this.board;
                    var firstRow = board[0];
                    var amount = incr ? 1 : -1;
                    var newHeight = this.board.length + amount;
                    ...
                    if (incr) {
                        ...
                        var row = board[board.length - 1];
                        row.forEach(function (box) { return box.b.b = 1; });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LAST_PLAYER_ID_KEY = 'dab-player-id';
            var GameService = /** @class */ (function () {
                function GameService() {
                    this.chatMessages = [];
                    this.joinError = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                GameService.prototype.sendNextBoard = function () {
                    var board = this.nextBoard;
                    if (!board) {
                        return;
                    }
                    this.send({ type: 'newBoard', board: board });
                    delete this.nextBoard;
                };
                GameService.prototype.chat = function (text) {
                    this.send({ type: 'chat', message: { sender: this.playerName, text: text } });
                };
                GameService.prototype.init = function () {
                    ...
                    this.ws.on('dab-message', function (msg) {
                        switch (msg.type) {
                            case 'game':
                                _this.game = msg.game;
                                _this.findPlayerInGame();
                                break;
                            case 'joined':
                                _this.playerId = _this.lastPlayerId = msg.playerId;
                                localStorage.setItem(LAST_PLAYER_ID_KEY, String(_this.lastPlayerId));
                                break;
                            case 'join-error':
                                _this.joinError.emit(msg.error);
                                setTimeout(function () { return _this.joinError.emit(); }, 3000);
                                break;
                            case 'chat':
                                if (_this.hasJoined) {
                                    _this.addChatMessage(msg.message);
                                }
                                break;
                        }
                    });
                ...
                GameService.prototype.addChatMessage = function (message) {
                ...
                GameService.prototype.findPlayerInGame = function () {
                    var _a = this, game = _a.game, lastPlayerId = _a.lastPlayerId;
                    if (!lastPlayerId) {
                        return;
                    }
                    if (game.players.some(function (player) { return player.id === lastPlayerId; })) {
                        this.playerId = lastPlayerId;
                    }
                };
                Object.defineProperty(GameService.prototype, "playerName", {
                    get: function () {
                        var _this = this;
                        var pl = this.game.players.find(function (player) { return player.id === _this.playerId; });
                        return pl ? pl.name : '?';
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(GameService.prototype, "hasJoined", {
                    get: function () {
                ...
                GameService.prototype.restart = function () {
                    this.send({ type: 'restartGame' });
                };
                GameService.prototype.click = function (row, box, line) {
                    var lineObj = _shared_board_service__WEBPACK_IMPORTED_MODULE_3__["getLine"](this.game.board, row, box, line);
                    ...
                    this.send({
                        ...
                        row: row, box: box, line: line
                    });
                };
                GameService.prototype.join = function (player) {
                    this.joinError.emit();
                    this.send({ type: 'join', player: player });
                };
                ...
                GameService.prototype.send = function (data) {
                ...
                Object.defineProperty(GameService.prototype, "isMyTurn", {
                    get: function () {
                        var currPlayer = this.currentPlayer;
                        return currPlayer && currPlayer.id === this.playerId;
                    },
                    enumerable: true,
                    configurable: true
                });
                GameService.prototype.isPlayerTurn = function (player) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function log() {
                ...
                console.log.apply(console, [new Date(Date.now()).toISOString()].concat(args));
            }
